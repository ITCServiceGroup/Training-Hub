...
export function initializeFloorplanVisuals(shadowRoot, currentFloorplanData) {
    ...
    const wallThickness = 4; // Further increased thickness for better visibility
    const internalWallColor = "#444"; // Darker internal wall color for better visibility
    ...
    if (currentFloorplanData.rooms) {
        currentFloorplanData.rooms.forEach(room => {
            ...
            label.style.left = (room.x + 10) + "px";
            label.style.top = (room.y + 10) + "px";
    ...
    if (currentFloorplanData.walls) {
        ...
        currentFloorplanData.walls.forEach(wall => {
            ...
            line.setAttribute("stroke-linecap", "butt"); // Use butt line caps for better alignment
            line.setAttribute("shape-rendering", "crispEdges"); // Ensure crisp rendering of lines
