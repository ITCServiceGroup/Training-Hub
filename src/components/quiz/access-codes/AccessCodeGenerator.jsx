    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-600 dark:text-slate-400">
          Enter learner and supervisor details exactly as they should appear in reporting.
        </p>
      </div>
      ...
      {generatedCode ? (
        ...
        <form onSubmit={handleGenerateCode} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full py-2.5 bg-primary hover:bg-primary-dark dark:bg-primary-dark dark:hover:bg-primary text-white font-semibold rounded-lg transition-colors disabled:opacity-50 disabled:dark:opacity-50"
